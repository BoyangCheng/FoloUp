...
/**
 * \u7ed9 call video \u751f\u6210\u5bf9\u8c61 key\uff1acall-videos/{call_id}/{timestamp}.{ext}
 * call_id \u5df2\u7ecf\u662f nanoid\uff0c\u4e0d\u9700\u8981\u518d sanitize\u3002
 *
 * ext \u9ed8\u8ba4 webm\uff08\u684c\u9762 Chrome / Android\uff09\uff1biOS Safari \u4e0d\u652f\u6301 webm \u5f55\u5236\uff0c
 * \u8d70 mp4 fallback \u65f6\u4f20 "mp4"\uff0c\u6587\u4ef6\u540d\u540e\u7f00\u540c\u6b65\u5207\u6362\uff0c\u6d4f\u89c8\u5668\u624d\u80fd\u6309\u6269\u5c55\u540d\u55c5\u63a2\u6b63\u786e mime \u64ad\u653e\u3002
 */
export function getCallVideoObjectKey(callId: string, ext: "webm" | "mp4" = "webm"): string {
  return `call-videos/${callId}/${Date.now()}.${ext}`;
}
 ...
 * - \u9996\u7247\uff08position=0\uff09\u4f20 contentType \u8ba9 OSS \u628a\u5bf9\u8c61\u7684 Content-Type \u8bbe\u6210\u5bf9\u5e94 mime\uff0c
 *   \u540e\u7eed\u7247\u4e0d\u9700\u8981\u4f20\u2014\u2014OSS \u6cbf\u7528\u9996\u7247\u7684 Content-Type\u3002
 *
...
export async function appendToOSS(
  ...
  const opts: Record<string, unknown> = { position: String(position) };
  // \u9996\u7247\u8bbe mime\uff1aOSS \u7528 ali-oss \u7684 mime \u9009\u9879\u628a Content-Type \u5199\u5230\u5bf9\u8c61 metadata\uff0c
  // \u540e\u7eed\u7247\u4e0d\u80fd\u518d\u8bbe\uff08OSS \u6821\u9a8c append \u4e0d\u5141\u8bb8\u6539 Content-Type\uff09
  if (position === 0 && contentType) {
    opts.mime = contentType;
    opts.headers = { "Content-Type": contentType };
  }
  const result = (await client.append(objectKey, buffer, opts as any)) as {
    nextAppendPosition?: number | string;
  };
