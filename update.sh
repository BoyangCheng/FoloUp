...
#
#  注意：
#  - 不再做 git pull。docker-compose.prod.yml / .env / 本脚本本身的更新
#    需要你手动 git pull 一次（避免脚本边跑边把自己换掉的麻烦）。
#  - build 不在 ECS 上做，前提是开发机已 ./push.sh 推送过新镜像。
# ============================================================
set -euo pipefail
